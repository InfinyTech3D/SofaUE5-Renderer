...
SofaUnreal-Linux-Debug:
	 $(PROJECTBUILD) SofaUnreal Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnreal-Linux-DebugGame:
	 $(PROJECTBUILD) SofaUnreal Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnreal-Linux-Shipping:
	 $(PROJECTBUILD) SofaUnreal Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnreal-Linux-Test:
	 $(PROJECTBUILD) SofaUnreal Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnreal:
	 $(PROJECTBUILD) SofaUnreal Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnrealEditor-Linux-Debug:
	 $(PROJECTBUILD) SofaUnrealEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnrealEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SofaUnrealEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnrealEditor-Linux-Shipping:
	 $(PROJECTBUILD) SofaUnrealEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnrealEditor-Linux-Test:
	 $(PROJECTBUILD) SofaUnrealEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SofaUnrealEditor:
	 $(PROJECTBUILD) SofaUnrealEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
