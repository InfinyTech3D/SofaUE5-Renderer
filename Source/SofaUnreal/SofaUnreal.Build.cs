...
public class SofaUnreal : ModuleRules
{
    ...
    public SofaUnreal(TargetInfo Target)
    {
    ...
    public bool loadSofaLib(TargetInfo Target)
    {
        ...
        Definitions.Add(string.Format("WITH_SOFA_LIB_BINDING={0}", isLibrarySupported ? 1 : 0));
